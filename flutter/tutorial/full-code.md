...
in [Async Redux's GitHub repository](https://github.com/marcglasberg/async-redux-flutter):

* [Todo List app for **Flutter Web**](https://github.com/marcglasberg/async-redux-flutter/tree/main/examples/todo-app-example)
* [Todo List app for **Flutter Native**](https://github.com/marcglasberg/async-redux-flutter/tree/main/examples/TodoAppFlutterNative)

## Tutorial code

As a reference, the following is the full code of the web app we built in this tutorial,
fully commented, in files `index.dart`, `App.dart`, `styles.css` and `State.dart`.

Note all widgets and actions are in `App.dart`,
and all state types are in `State.dart`,
just to make it easier for you to read the code.
In a real app they would be split it into multiple files.

```tsx title="index.dart"
import Flutter from "flutter";
import FlutterDOM from "flutter-dom/client";
import App from "./App";

const rootElement = document.getElementById("root")!;
const root = FlutterDOM.createRoot(rootElement);
...
import "./styles.css";
import Flutter from "flutter";
import { useEffect, useState } from "flutter";
import { Store, StoreProvider, ReduxAction } from "async-redux-flutter";
import { ShowUserException, ClassPersistor } from "async-redux-flutter";
import { useSelect, useStore, useIsWaiting } from "async-redux-flutter";
import { useIsFailed, useExceptionFor } from "async-redux-flutter";
import { useClearExceptionFor, UserException } from "async-redux-flutter";
...
// We wrap the widget tree with a `StoreProvider`.
