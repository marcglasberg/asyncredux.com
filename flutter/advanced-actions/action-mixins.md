...
| [Sequential](./control-mixins)                   | Runs actions one at a time, in the order they were dispatched              | `before`, `after`             |
...
|                                 | Check<br/>Internet | No<br/>Dialog | Abort<br/>When<br/>No<br/>Internet | Non<br/>Reentrant | Retry | Unlimited<br/>Retries | Unlimited<br/>Retry<br/>Check<br/>Internet | Throttle | Debounce | Fresh | Optimistic<br/>Command | Optimistic<br/>Sync | Optimistic<br/>Sync<br/>WithPush | Server<br/>Push | Polling | Sequential |
|---------------------------------|:------------------:|:-------------:|:----------------------------------:|:-----------------:|:-----:|:---------------------:|:------------------------------------------:|:--------:|:--------:|:-----:|:----------------------:|:-------------------:|:--------------------------------:|:---------------:|:-------:|:----------:|
| **CheckInternet**               |         —          |       ✅       |                 ❌                  |         ✅         |  ✅️   |          ✅️           |                     ❌                      |    ✅     |    ✅     |   ✅   |           ✅            |          ✅          |                ✅                 |        ❌        |   ⚠️    |     ✅     |
| **NoDialog**                    |         ➡️         |       —       |                 ❌                  |         ✅         |  ✅️   |          ✅️           |                     ❌                      |    ✅     |    ✅     |   ✅   |           ✅            |          ✅          |                ✅                 |        ❌        |    ✅    |     ✅     |
| **AbortWhenNoInternet**         |         ❌          |       ❌       |                 —                  |         ✅         |  ✅️   |          ✅️           |                     ❌                      |    ✅     |    ✅     |   ✅   |           ✅            |          ✅          |                ✅                 |        ❌        |   ⚠️    |     ✅     |
| **NonReentrant**                |         ✅          |       ✅       |                 ✅                  |         —         |   ✅   |           ✅           |                     ❌                      |    ❌     |    ✅     |   ❌   |           ❌            |          ❌          |                ❌                 |        ❌        |   ⚠️    |     ✅     |
| **Retry**                       |         ✅️         |      ✅️       |                 ✅️                 |         ✅         |   —   |           ✅           |                     ❌                      |    ✅     |    ❌     |   ✅   |           ✅            |          ❌          |                ❌                 |        ❌        |    ❌    |     ✅     |
...
#### ⚠️ Can be combined, but read the caveat in the mixin page
