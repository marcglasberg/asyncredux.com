...
|                                 | Check<br/>Internet | No<br/>Dialog | Abort<br/>When<br/>No<br/>Internet | Non<br/>Reentrant | Retry | Unlimited<br/>Retries | Unlimited<br/>Retry<br/>Check<br/>Internet | Throttle | Debounce | Fresh | Optimistic<br/>Command | Optimistic<br/>Sync | Optimistic<br/>Sync<br/>WithPush | Server<br/>Push | Polling |
|---------------------------------|:------------------:|:-------------:|:----------------------------------:|:-----------------:|:-----:|:---------------------:|:------------------------------------------:|:--------:|:--------:|:-----:|:----------------------:|:-------------------:|:--------------------------------:|:---------------:|:-------:|
| **CheckInternet**               |         —          |       ✅       |                 ❌                  |         ✅         |  ✅️   |          ✅️           |                     ❌                      |    ✅     |    ✅     |   ✅   |           ✅            |          ✅          |                ✅                 |        ❌        |    ✅    |
| **NoDialog**                    |         ➡️         |       —       |                 ❌                  |         ✅         |  ✅️   |          ✅️           |                     ❌                      |    ✅     |    ✅     |   ✅   |           ✅            |          ✅          |                ✅                 |        ❌        |    ✅    |
