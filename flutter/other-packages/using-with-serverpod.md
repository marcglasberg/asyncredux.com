...
If your app uses AsyncRedux and your server uses Serverpod, you can add the Dart-only core
...
and you have set up the `UserExceptionDialog` ([See here](../basics/failed-actions#showing-error-messages)),
 AsyncRedux will display the exception message to the user in a dialog (or other UI element that you can customize).
